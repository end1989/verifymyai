// Detailed follow-up ('documentation') prompts, keyed by audit prompt id.
// Kept in a data module (not the component) so DocumentationPrompt.jsx only exports a component.
