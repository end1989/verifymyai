  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
      <button
        ...
        className="w-full text-left p-4 flex justify-between items-center hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
        aria-expanded={open}
      >
        <span className="font-medium text-slate-700 dark:text-slate-200 text-sm">How to take screenshots that hold up as evidence</span>
        <span className="text-slate-400 dark:text-slate-500 text-xs" aria-hidden="true">{open ? 'close' : 'read this'}</span>
      </button>

      {open && (
        <div className="px-4 pb-4 space-y-4 text-sm text-slate-600 dark:text-slate-300">
          ...
          <div className="space-y-3">
            <div className="pl-3 border-l-2 border-slate-300 dark:border-slate-600 space-y-1">
              <p className="font-medium text-slate-700 dark:text-slate-200">1. Capture your entire screen -- not just the window</p>
            ...
            <div className="pl-3 border-l-2 border-slate-300 dark:border-slate-600 space-y-1">
              <p className="font-medium text-slate-700 dark:text-slate-200">2. Make sure the URL bar is visible</p>
            ...
            <div className="pl-3 border-l-2 border-slate-300 dark:border-slate-600 space-y-1">
              <p className="font-medium text-slate-700 dark:text-slate-200">3. Make sure your system clock is visible</p>
            ...
            <div className="pl-3 border-l-2 border-amber-300 dark:border-amber-700 space-y-1">
              <p className="font-medium text-amber-800 dark:text-amber-300">4. Open a date-verification tab (strongest timestamp)</p>
            ...
            <div className="pl-3 border-l-2 border-slate-300 dark:border-slate-600 space-y-1">
              <p className="font-medium text-slate-700 dark:text-slate-200">5. Email it to yourself immediately</p>
            ...
            <div className="pl-3 border-l-2 border-slate-300 dark:border-slate-600 space-y-1">
              <p className="font-medium text-slate-700 dark:text-slate-200">6. Don't edit or crop</p>
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-3 space-y-1">
            <p className="font-medium text-slate-700 dark:text-slate-200">Quick checklist before you take each screenshot:</p>
